	...
	render(){
		return(
			<div className="page container">
				...
				<p className="text text-center">Below are the projects that I am most proud of. Visit my <a href="https://github.com/merileewheelock" target="_blank">Github</a> profile to see more of my code.</p>
